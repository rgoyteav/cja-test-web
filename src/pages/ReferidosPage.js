...
const ReferidosPage = () => {
  return (
    <div className="container mt-5">
      ...
      <div className="mt-4">
        <p>
          El Programa de Referidos 2025 premiará a los socios que inviten nuevos miembros al club. Este programa buscará fidelizar los socios activos
          y aumentar la masa societaria del Centro Juventud Antoniana.
        </p>
        <p>Muy pronto habrá novedades.</p>
